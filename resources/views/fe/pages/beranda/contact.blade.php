...
@push('meta-seo')
    <title>Contact - Rentify</title>
    <meta content="Halaman Contact Rentify" name="description">
    ...
    <nav class="navbar navbar-expand-lg bg-white fixed-top">
        <div class="container d-block border-bottom" style="max-width: 768px;">
            <ul class="navbar-nav flex-row justify-content-between align-items-center mx-auto">
                ...
                <li>
                    <h5 class="fs-7 fw-bolder">Contact</h5>
                </li>
                <li class="nav-item">
...
@section('content')
    <div class="row" style="margin:5rem 0;">
        <div class="col-12">
            <h4 class="fw-bolder text-dark text-center">Our Contact</h4>
        </div>
    </div>
@endsection
@push('js')
